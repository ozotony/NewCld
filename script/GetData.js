...
app.factory('authService', ['$http', '$q', '$rootScope', 'localStorageService', function ($http, $q, $rootScope, localStorageService) {
  ...
  //  var serviceBase = 'http://5.77.54.44/NewTrademark/';
    ...
    var serviceBaseAdmin = 'http://5.77.54.44/CldAdmin/';

    var serviceBaseCld = "http://tm.cldng.com/";

    //  var serviceBaseCld = "http://localhost:4556/";

    var oldserviceBase = 'http://ipo.cldng.com/Handlers/GetRegistration.ashx';
    ...
    var _GetUserById = function (dd) {
        ...
        $http.get(serviceBase + 'api/account/GetRegistrationById', { params: data }, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
    ...
    var _ChangePassword = function (registration) {
        var dd = "";
        return $http.post(serviceBase + 'api/account/ChangePassword', registration, {
            headers: {
                'Content-Type': 'application/json'
            }
        })
    ...
    var _getBasket22 = function (dd, dd2) {
        // var serviceBase2 = "http://localhost:24322/";
        var deferred = $q.defer();
        ...
        $http.get(serviceBase + 'api/account/getBasketDetail2', { params: data }, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
    ...
    authServiceFactory.getBasket22 = _getBasket22;
