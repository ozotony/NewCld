(function (window) {
  ...
  //  var serviceBasePatent = "http://localhost:55482/";
    
   // var serviceBasePayment = "http://payx.com.ng/";
    var serviceBasePayment = "http://5.77.54.44/EinaoTestEnvironment.Payx/";
 //  var serviceBaseDesign = "http://ds.cldng.com/";
    var serviceBaseDesign = "http://5.77.54.44/EinaoTestEnvironment.Design/";
 //   var logoutlink = "http://www.iponigeria.com/#/logout";
   var logoutlink = "http://5.77.54.44/EinaoTestEnvironment.IpoNigeria/#/logout";
            ...
            function ($stateProvider,
               ...
               //$locationProvider.html5Mode(true);
                ...
                $stateProvider
                    ...
                    .state('RecordalPatent', {
                        url: '/RecordalPatent',
                        templateUrl: "partial/RecordalPatent.html",
                        controller: 'RecordalPatentController',
                        cache: false
                    ...
                    .state('AppealRefusal', {
                        url: '/AppealRefusal',
                        templateUrl: "partial/AppealRefusal.html",
                        controller: 'AppealRefusalController',
                        cache: false
                    ...
                    .state('PaymentRequery', {
                        url: '/PaymentRequery',
                        templateUrl: "partial/PaymentRequery.html",
                        controller: 'PaymentRequeryController'
 ...
 .state('Role.Detail', {
     ...
     controller: 'RolesController'
       ...
       app.controller('Home3Controller', function ($scope, $http, $rootScope, localStorageService, authService, authService2, $sce, $filter, $location, $state, $document) {
           ...
           if ($state.params.MessageID != null) {
             ...
             //  authService.GetAgent(kk9).then(function (data, status) {
               authService.GetUserById(kk9).then(function (data, status) {
                   var dd = data;
             ...
             //  localStorageService.set("count", '3');
              ...
              // var aap = localStorageService.get("count");
               ...
               $scope.add2 = function (vrow) {
                   var serviceBase2 = serviceBaseIpo+ 'Handlers/GetEmail2.ashx';
...

           {
               ...
               $scope.submit4 = function (dd) {
                   ...
                   OpenWindowWithPost2("http://5.77.54.44/CldAdmin3/#/Article?userId=" + dd.NewsID, "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile");
               }
       ...
       app.controller('AgentAccreditationController', function ($scope, $http, $rootScope, localStorageService, authService, authService2, $sce, $filter, $location, $uibModal) {
           ...
           var url3 = serviceBaseIpo +  "Handlers/Approve.ashx";
           var url6 = serviceBaseIpo +  "Handlers/Reject.ashx";
    ...
    app.controller('PaymentRequeryController', function ($scope, $http, $rootScope, localStorageService, authService, authService2, $sce, $filter, $location, $uibModal) {
        ...
        $rootScope.HeaderMessage = "Payment Requery";

        $rootScope.isFee = true;
        //  if (localStorageService.get("Email") != null) {
        $rootScope.count22 = '200';
        $rootScope.count2 = '200';

        //   }

        localStorageService.set("count", '200');
       ...
       // $rootScope.count = '00';
        ...
        OpenWindowWithPost2(serviceBasePayment+"Requery_Tool.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile");
       ...
       app.controller('CertificateController', function ($scope, $http, $rootScope, localStorageService, $location, authService, $window, $sce, $state, $filter) {
          ...
          // var serviceBaseIpo = serviceBaseIpo;

          // var serviceBaseCld = serviceBaseCld ;
           ...
           $rootScope.HeaderMessage = "Recordal";
           $rootScope.count = '00';

           $rootScope.count2 = '124';
    ...
    app.controller('AppealRefusalController', function ($scope, $http, $rootScope, localStorageService, $location, authService, $window, $sce, $state, $filter) {
       ...
       app.controller('UploadDocController', function ($scope, $http, $rootScope, localStorageService, $location, authService, $window, $sce, $state, $filter) {
               ...
               if (aa == undefined) {
                   ...
                   if (aa == "Trademark") {
                       ...
                       if (bb == "Online No") {
                           ...
                           var serviceBase = serviceBaseDesign + 'Handlers/GetData4a.ashx';
                           ...
                           var serviceBase = serviceBaseDesign + 'Handlers/GetData5a.ashx';
           ...
           $scope.Ddx10 = function () {
               if ($scope.apptype == "Patent") {
                   $scope.submitPatent();
               }

               if ($scope.apptype == "Trademark") {
                   $scope.submitTrademark();
               }

               if ($scope.apptype == "Design") {
                   $scope.submitDesign();
               }
               
           }

           $scope.submitTrademark = function () {
              ...
              // formData.append("vv", JSON.stringify($scope.xid2));
               formData.append("vv",$scope.xid2);

               var url9 = serviceBaseCld + "Handlers/Save_GenericApplication4.ashx";

               //var url9 = "http://localhost:49703/Handlers/Save_GenericApplication4.ashx";
           ...
           $scope.submitPatent = function () {
               ...
               try {
                   ...
                   totalFiles = document.getElementById("File11").files.length;
               }
               catch (Ex) {
               ...
               var totalFiles2;
               try {
                   totalFiles2 = document.getElementById("File12").files.length;
               }
               catch (Ex) {
               ...
               var totalFiles3;
               try {
                   totalFiles3 = document.getElementById("File13").files.length;
               }
               catch (Ex) {
               ...
               var totalFiles4;
               try {
                   totalFiles4 = document.getElementById("File14").files.length;
               }
               ...
               var totalFiles5;
               try {
                   totalFiles5 = document.getElementById("File15").files.length;
               }
               ...
               for (var i = 0; i < totalFiles; i++) {
                   var file = document.getElementById("File11").files[i];
               ...
               for (var i = 0; i < totalFiles2; i++) {
                   var file = document.getElementById("File12").files[i];
               ...
               for (var i = 0; i < totalFiles3; i++) {
                   var file = document.getElementById("File13").files[i];
               ...
               for (var i = 0; i < totalFiles4; i++) {
                   var file = document.getElementById("File14").files[i];
               ...
               for (var i = 0; i < totalFiles5; i++) {
                   var file = document.getElementById("File15").files[i];
               ...
               formData.append("vv", $scope.number);

              
               var url9 = "";
              
               if ($scope.Searchname == "Online No") {

                   url9 = serviceBasePatent + "Handlers/Save_GenericApplication3.ashx";
               }

               else {

                   url9 = serviceBasePatent + "Handlers/Save_GenericApplication4.ashx";
               }
           ...
           $scope.submitDesign = function () {
               ...
               var totalFiles;
               try {
                   totalFiles = document.getElementById("File1a").files.length;
               }
               catch (Ex) {
               ...
               var totalFiles2;
               try {
                   totalFiles2 = document.getElementById("File2a").files.length;
               }
               catch (Ex) {
               ...
               var totalFiles3;
               try {
                   totalFiles3 = document.getElementById("File3a").files.length;
               }
               catch (Ex) {
               ...
               var totalFiles4;
               try {
                   totalFiles4 = document.getElementById("File4a").files.length;
               }
               ...
               var totalFiles5;
               try {
                   totalFiles5 = document.getElementById("File5a").files.length;
               }
               ...
               var totalFiles6;
               try {
                   totalFiles6 = document.getElementById("File6a").files.length;
               }
               ...
               var totalFiles7;
               try {
                   totalFiles7 = document.getElementById("File7a").files.length;
               }
               ...
               var totalFiles8;
               try {
                   totalFiles8 = document.getElementById("File8a").files.length;
               }
               ...
               for (var i = 0; i < totalFiles; i++) {
                   var file = document.getElementById("File1a").files[i];
               ...
               for (var i = 0; i < totalFiles2; i++) {
                   var file = document.getElementById("File2a").files[i];
               ...
               for (var i = 0; i < totalFiles3; i++) {
                   var file = document.getElementById("File3a").files[i];
               ...
               for (var i = 0; i < totalFiles4; i++) {
                   var file = document.getElementById("File4a").files[i];
               ...
               for (var i = 0; i < totalFiles5; i++) {
                   var file = document.getElementById("File5a").files[i];
               ...
               for (var i = 0; i < totalFiles6; i++) {
                   var file = document.getElementById("File6a").files[i];
               ...
               for (var i = 0; i < totalFiles7; i++) {
                   var file = document.getElementById("File7a").files[i];
               ...
               for (var i = 0; i < totalFiles8; i++) {
                   var file = document.getElementById("File8a").files[i];
               ...
               if ($scope.Searchname == "Online No") {
                   ...
                   url9 = serviceBaseDesign + "Handlers/Save_GenericApplication3.ashx";
               }

               else {

                   url9 = serviceBaseDesign + "Handlers/Save_GenericApplication4.ashx";
               }
           ...
           $scope.returnval2 = function (response) {
               var serviceBasePt = serviceBasePatent;
               $scope.showtrademark = false;
           ...
           $scope.returnval3 = function (response) {
               $scope.showtrademark = false;
               $scope.showpatent = false;
               ...
               if (response.loa_doc != "" || response.loa_doc == "") {
                   $scope.formData.logo_pic = serviceBaseDesign + "admin/pt/" + response.loa_doc;
                   $scope.formData.show = true;

               }
               if (response.ns_doc != "" || response.ns_doc == "") {
                   $scope.formData.ns_doc = serviceBaseDesign + "admin/pt/" + response.ns_doc;
                   $scope.formData.show2 = true;
               }
               if (response.pd_doc != "" || response.pd_doc == "") {
                   $scope.formData.pd_doc = serviceBaseDesign + "admin/pt/" + response.pd_doc;
                   $scope.formData.show3 = true;
               }
               if (response.doa_doc != "" || response.doa_doc == "") {
                   $scope.formData.doa_doc = serviceBaseDesign + "admin/pt/" + response.doa_doc;
                   $scope.formData.show4 = true;
               }
               if (response.rep_pic != "" || response.rep_pic == "") {
                   $scope.formData.rep_pic = serviceBaseDesign + "admin/pt/" + response.rep_pic;
                   $scope.formData.show5 = true;
               }

               if (response.rep2_pic != "" || response.rep2_pic == "") {
                   $scope.formData.rep2_pic = serviceBaseDesign + "admin/pt/" + response.rep2_pic;
                   $scope.formData.show6 = true;
               }

               if (response.rep3_pic != "" || response.rep3_pic == "") {
                   $scope.formData.rep3_pic = serviceBaseDesign + "admin/pt/" + response.rep3_pic;
                   $scope.formData.show7 = true;
               }

               if (response.rep4_pic != "" || response.rep4_pic == "") {
                   $scope.formData.rep4_pic = serviceBaseDesign + "admin/pt/" + response.rep4_pic;
       ...
       app.controller('RecordalController', function ($scope, $http, $rootScope, localStorageService, $location, authService, $window, $sce, $state, $filter) {
          ...
          // alert($scope.aa.Getstatus)
           ...
           $scope.Ddx = function (aa) {
               if (aa == undefined) {
                  ...
                  // localStorageService.set("recordal", aa.Getstatus)
                   ...
                   if (aa == "Paycert") {
                       $state.transitionTo('Certificate', null, { 'reload': true });
                   }

                   else if (aa == "Appeal") {
                       $state.transitionTo('AppealRefusal', null, { 'reload': true });
                   }
           ...
           function (isConfirm) {
               if (isConfirm) {
                 ...
                 //  doUrlPost("xindex_manual.aspx", "", "0", vsys_id, xname, "", "", "", xaddress, "", xname, xemail, xPhoneNumber, "", "", "", "", "")
                   OpenWindowWithPost(serviceBaseIpo + "A/xindex_manual.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
           ...
           $scope.add8 = function (aa, bb) {
               ...
               //  doUrlPost("xindex_manual.aspx", "", "0", vsys_id, xname, "", "", "", xaddress, "", xname, xemail, xPhoneNumber, "", "", "", "", "")
               OpenWindowWithPost(serviceBaseCld + "admin/tm/Change_ApplicantAgent.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
           ...
           , { Transaction_Status: 'FORM 17', Transaction_Status2: 'ASSIGNMENT (REQUEST TO THE REGISTRAR TO REGISTER A SUBSEQUENT PROPRIETOR OF A TRADE MARK ...' }
            ...
            , { Transaction_Status: 'CHANGEAGENT', Transaction_Status2: 'RECORDAL OF CHANGE OF AGENT' }
               ...
               , { Transaction_Status: 'Paycert', Transaction_Status2: 'PAY FOR CERTIFICATE' }
               , { Transaction_Status: 'Appeal', Transaction_Status2: 'APPEAL REFUSAL' }];
    ...
    app.controller('RecordalPatentController', function ($scope, $http, $rootScope, localStorageService, $location, authService, $window, $sce, $state, $filter) {
        ...
        $scope.varray44 = [{ Transaction_Status: 'P007', Transaction_Status2: 'APPLICATION FOR ALTERATION IN THE REGISTER OF PATENTS' }];
       ...
       app.controller('ViewBasketTmController', function ($scope, $http, $rootScope, localStorageService, $location, authService, $window, $sce, $filter) {
               ...
               if (localStorageService.get("ViewBasketDetails") != null) {
                   ...
                   if ((detail2.item_code == "T002") || (detail2.item_code == "T102")) {
                    ...
                    //   $location.path("/ApplicationFileToo2");
                       ...
                       OpenWindowWithPost(serviceBaseCld + "xind.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
                       ...
                       OpenWindowWithPost(serviceBaseCld + "gf/xindex.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
           ...
           $scope.EditRow44 = function () {
            ...
            //   alert(id)
               ...
               authService.getBasket22("tm", id).then(function (data, status) {
       ...
       app.controller('ViewBasketPtController', function ($scope, $http, $rootScope, localStorageService, $location, authService, $window, $sce, $filter) {
           ...
           $scope.submitForm3 = function () {
               ...
               if ((detail2.item_code == "P001") || (detail2.item_code == "P002") || (detail2.item_code == "P102")) {
                   ...
                   OpenWindowWithPost(serviceBasePatent +"xindex.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
                   ...
                   OpenWindowWithPost(serviceBasePatent + "xindex_ren.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
           ...
           $scope.EditRow44 = function () {
               ...
               authService.getBasket22("pt", id).then(function (data, status) {
                   $scope.itemsByPage = 30;
                   $scope.vshow2 = true;
                   $scope.vshow = false;
                   $scope.ListAgent2 = data;
       ...
       app.controller('ViewBasketDsController', function ($scope, $http, $rootScope, localStorageService, $location, authService, $window, $sce, $filter) {
           ...
           $scope.submitForm3 = function () {
               ...
               if ((detail2.item_code == "D002") || (detail2.item_code == "D003") || (detail2.item_code == "D102")) {
                   ...
                   OpenWindowWithPost(serviceBaseDesign + "xindex.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
                   ...
                   OpenWindowWithPost(serviceBaseDesign + "xindex_ren.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
           ...
           $scope.EditRow44 = function () {
               ...
               authService.getBasket22("ds", id).then(function (data, status) {
                   $scope.itemsByPage = 30;
                   $scope.vshow2 = true;
                   $scope.vshow = false;
                   $scope.ListAgent2 = data;
                   ...
                   authService.getPwalletCount($rootScope.Details.new_transID).then(function (data, status) {
                       ...
                       if ((data > 0)) {
                           ...
                           authService.PostAll(formData).then(function (data, status) {
                               ...
                               window.open(serviceBaseCld + "tm_ark_repc2b.aspx?0001234445=" + content, '_blank');
       ...
       //    localStorageService.set("count", '32');
        ...
        //   var aap = localStorageService.get("count");
           ...
           authService.ReturnUrl().then(function (data, status) {
               ...
               $scope.Returnurl2 = parseInt(data.Amount) / 100;
               $scope.Returnurl3 = $scope.Returnurl2 - $scope.vTotal;
               ...
               function (isConfirm) {
                   if (isConfirm) {
                       ...
                       if (xname5 == "FORM 22") {
                           ...
                           OpenWindowWithPost(serviceBaseCld + "admin/tm/Change_ApplicantName.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
                       ...
                       if (xname5 == "FORM 19") {
                           ...
                           OpenWindowWithPost(serviceBaseCld + "admin/tm/Change_ApplicantAddress.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
                           // doUrlPost(serviceBaseCld + "/admin/tm/Change_ApplicantName.aspx", xname2, xname3, xname4)
                       }
                       ...
                       if (xname5 == "FORM 26") {
                           ...
                           OpenWindowWithPost(serviceBaseCld + "admin/tm/Change_Rectification.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
                           // doUrlPost(serviceBaseCld + "/admin/tm/Change_ApplicantName.aspx", xname2, xname3, xname4)
                       }
                       ...
                       if (xname5 == "FORM 12") {
                           ...
                           OpenWindowWithPost(serviceBaseCld + "admin/tm/Change_Renewal.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
                           // doUrlPost(serviceBaseCld + "/admin/tm/Change_ApplicantName.aspx", xname2, xname3, xname4)
                       }
                       ...
                       if (xname5 == "FORM 16") {
                           ...
                           OpenWindowWithPost(serviceBaseCld + "admin/tm/Change_Assignment2.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
                           // doUrlPost(serviceBaseCld + "/admin/tm/Change_ApplicantName.aspx", xname2, xname3, xname4)
                       }
                       ...
                       if (xname5 == "FORM 17") {
                           ...
                           OpenWindowWithPost(serviceBaseCld + "admin/tm/Change_Assignment3.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
                           // doUrlPost(serviceBaseCld + "/admin/tm/Change_ApplicantName.aspx", xname2, xname3, xname4)
                       }
                       ...
                       if (xname5 == "FORM 47") {
                           ...
                           OpenWindowWithPost(serviceBaseCld + "admin/tm/RegisteredUser.aspx", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile", param);
                           // doUrlPost(serviceBaseCld + "/admin/tm/Change_ApplicantName.aspx", xname2, xname3, xname4)
                       }
    ...
    app.controller('SuccessController', function ($scope, $http, $rootScope, localStorageService, authService, $state, $location, $filter) {
             ...
             //  $location.path("/Fee");
               ...
               if ((aa)) {
                ...
                //   Applicant.applicantname = $scope.ApplicantForm.firstname + " " + $scope.ApplicantForm.Lastname;
                   Applicant.applicantname = $scope.ApplicantForm.firstname;
    ...
    app.controller('ChangePasswordController', function ($scope, $http, $rootScope, localStorageService, authService, $location, $sce, $filter) {
        // $scope.ApplicantForm.Lastname = ""
        $scope.ApplicantForm = {};
        if (localStorageService.get("username") == null) {
            //  alert("username=" + localStorageService.get("username"))
        ...
        $rootScope.HeaderMessage = "Change Password";

        $rootScope.isFee = true;

        // localStorageService.set("count", '32');

        $rootScope.count22 = '202b';

        //  var aap = localStorageService.get("count");

        // alert(aap)
        $rootScope.count = '00';
        $rootScope.count2 = '302';
        ...
        $scope.submitForm = function (aa) {
            ...
            if ((aa)) {
                ...
                if ($scope.ApplicantForm.Email != $scope.ApplicantForm.Phonenumber) {
                    swal("", "New Password And Confirm Password Must Be Equal", "error")
                    return;
                }
                ...
                var AgentsData = {
                    ...
                    OldPassword: $scope.ApplicantForm.firstname,
                    NewPassword: $scope.ApplicantForm.Email,
                    ConfirmPassword: $scope.ApplicantForm.Phonenumber,

                };

                authService.ChangePassword(JSON.stringify(AgentsData)).then(function (data, status) {
       ...
       app.controller('TrademarkStatusController', function ($scope, $http, $rootScope, localStorageService, authService, $location, $sce, $filter, $uibModal, $window) {
           ...
           $scope.Ddx10 = function (dd,dd2) {
               var kk = dd2
             //  var dds = "http://tm.cldng.com/admin/tm/registrar_ack.aspx?0001234445=" + dd + "&94384238=" + kk;
               console.log("link")
              // console.log(dds)
             //  Window.open("http://tm.cldng.com/admin/tm/registrar_ack.aspx?0001234445=" + dd + "&94384238=" + kk,"_blank")

               OpenWindowWithPost2(serviceBaseCld + "admin/tm/registrar_ack2.aspx?0001234445=" + dd + "&94384238=" + kk, "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile");
           }


           $scope.Ddx100 = function (dd) {
             

               OpenWindowWithPost2(serviceBaseCld + "admin/tm/acceptance_slip_details.aspx?x=" + dd + " &x2=tt", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile");
           }

           $scope.Ddx102 = function (dd) {


               OpenWindowWithPost2(serviceBaseCld + "admin/tm/rejection_slip_details.aspx?x=" + dd + " &x2=tt", "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile");
           }
           ...
           $scope.Ddx = function (dxp, dxp2) {
               ...
               if (dxp == "TransactionId") {
                   ...
                   authService.getTrademarkStatus(dxp2).then(function (data, status) {
                       ...
                       if (data.lt_pw[0].data_status != "Fresh" && data.lt_pw[0].data_status != "Valid" && data.lt_pw[0].data_status != "Withdraw" && data.lt_pw[0].data_status != "Re-conduct search" && data.lt_pw[0].data_status != "Search Conducted" && data.lt_pw[0].data_status != "Search 2 Conducted" && data.lt_pw[0].data_status != "Invalid" && data.lt_pw[0].data_status != "Re-examine" && data.lt_pw[0].data_status != "Registrable" && data.lt_pw[0].data_status != "Refused" && data.lt_pw[0].data_status != "Non-registrable" && data.lt_pw[0].data_status.toUpperCase() != "KIV") {
                           $scope.vshow2 = true;
                       }

                       if (data.lt_pw[0].data_status == "Refused" ) {
                           $scope.vshow3 = true;
                       }
                       if (data.vcount > 0) {
                           $scope.vshow = true;
       ...
       app.controller('DesignStatusController', function ($scope, $http, $rootScope, localStorageService, authService, $location, $sce, $filter, $uibModal, $window) {
           ...
           $scope.Ddx10 = function (dd) {
               ...
               OpenWindowWithPost2(serviceBaseDesign + "tm_acknowledgement2.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD=" + dd, "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile");
           }
       ...
       app.controller('PatentStatusController', function ($scope, $http, $rootScope, localStorageService, authService, $location, $sce, $filter, $uibModal, $window) {
           ...
           $scope.Ddx10 = function (dd) {
              ...
              // console.log(dds)
               ...
               OpenWindowWithPost2(serviceBasePatent + "tm_acknowledgement2.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD=" + dd , "width=1000, height=600, left=100, top=100, resizable=yes, scrollbars=yes", "NewFile");
           }
    ...
    function (isConfirm) {
       ...
       app.controller('logoutController', function ($scope, $http, $rootScope, localStorageService, authService, authService2, $location, $state, $filter) {
         ...
         //  http://5.77.54.44/EinaoTestEnvironment.IpoNigeria/#/logout
